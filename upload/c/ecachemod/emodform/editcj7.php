...
</td></tr><tr><td bgcolor=ffffff>副标题</td><td bgcolor=ffffff><input name="ftitle" type="text" id="ftitle" value="<?=$ecmsfirstpost==1?"":DoRehValue($modid,'ftitle',stripSlashes($r['ftitle']))?>" size="60">
...
</td></tr><tr><td bgcolor=ffffff>内容简介</td><td bgcolor=ffffff><textarea name="smalltext" cols="80" rows="10" id="smalltext"><?=$ecmsfirstpost==1?"":DoRehValue($modid,'smalltext',stripSlashes($r['smalltext']))?></textarea>
...
<input type="button" name="wbutton" value="增加作者" onclick="window.open('NewsSys/writer.php?<?=$ecms_hashur['ehref']?>&addwritername='+document.add.writer.value);"></td></tr><tr><td bgcolor=ffffff>信息来源</td><td bgcolor=ffffff><?php
$b_class='';
