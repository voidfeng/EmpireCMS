...
?>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_movietype]" cols="60" rows="10" id="zz_movietype"><?=ehtmlspecialchars(stripSlashes($r['zz_movietype']))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_movietype]" type="text" id="z_movietype" value="<?=stripSlashes($r['z_movietype'])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_company]" cols="60" rows="10" id="zz_company"><?=ehtmlspecialchars(stripSlashes($r['zz_company']))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_company]" type="text" id="z_company" value="<?=stripSlashes($r['z_company'])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_movietime]" cols="60" rows="10" id="zz_movietime"><?=ehtmlspecialchars(stripSlashes($r['zz_movietime']))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_movietime]" type="text" id="z_movietime" value="<?=stripSlashes($r['z_movietime'])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_player]" cols="60" rows="10" id="zz_player"><?=ehtmlspecialchars(stripSlashes($r['zz_player']))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_player]" type="text" id="z_player" value="<?=stripSlashes($r['z_player'])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_playadmin]" cols="60" rows="10" id="zz_playadmin"><?=ehtmlspecialchars(stripSlashes($r['zz_playadmin']))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_playadmin]" type="text" id="z_playadmin" value="<?=stripSlashes($r['z_playadmin'])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_filetype]" cols="60" rows="10" id="zz_filetype"><?=ehtmlspecialchars(stripSlashes($r['zz_filetype']))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_filetype]" type="text" id="z_filetype" value="<?=stripSlashes($r['z_filetype'])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_filesize]" cols="60" rows="10" id="zz_filesize"><?=ehtmlspecialchars(stripSlashes($r['zz_filesize']))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_filesize]" type="text" id="z_filesize" value="<?=stripSlashes($r['z_filesize'])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_star]" cols="60" rows="10" id="zz_star"><?=ehtmlspecialchars(stripSlashes($r['zz_star']))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_star]" type="text" id="z_star" value="<?=stripSlashes($r['z_star'])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_playdk]" cols="60" rows="10" id="zz_playdk"><?=ehtmlspecialchars(stripSlashes($r['zz_playdk']))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_playdk]" type="text" id="z_playdk" value="<?=stripSlashes($r['z_playdk'])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_playtime]" cols="60" rows="10" id="zz_playtime"><?=ehtmlspecialchars(stripSlashes($r['zz_playtime']))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_playtime]" type="text" id="z_playtime" value="<?=stripSlashes($r['z_playtime'])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_moviefen]" cols="60" rows="10" id="zz_moviefen"><?=ehtmlspecialchars(stripSlashes($r['zz_moviefen']))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_moviefen]" type="text" id="z_moviefen" value="<?=stripSlashes($r['z_moviefen'])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_downpath]" cols="60" rows="10" id="zz_downpath"><?=ehtmlspecialchars(stripSlashes($r['zz_downpath']))?></textarea></td>
        </tr>
        <tr> 
          <td>地址前缀:
<input name="add[qz_downpath]" type="text" id="qz_downpath" value="<?=stripSlashes($r['qz_downpath'])?>">
        </td>
        </tr>
      </table></td>
  </tr>
...
?>
  <tr bgcolor="#FFFFFF"> 
    ...
    <td><select name="add[z_playerid]" id="z_playerid"><option value=0>自动识别</option><?=$player_class?></select></td>
  </tr>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_onlinepath]" cols="60" rows="10" id="zz_onlinepath"><?=ehtmlspecialchars(stripSlashes($r['zz_onlinepath']))?></textarea></td>
        </tr>
        <tr> 
          <td>地址前缀:
<input name="add[qz_onlinepath]" type="text" id="qz_onlinepath" value="<?=stripSlashes($r['qz_onlinepath'])?>">
        </td>
        </tr>
      </table>
	  </td>
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_moviesay]" cols="60" rows="10" id="zz_moviesay"><?=ehtmlspecialchars(stripSlashes($r['zz_moviesay']))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_moviesay]" type="text" id="z_moviesay" value="<?=stripSlashes($r['z_moviesay'])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
