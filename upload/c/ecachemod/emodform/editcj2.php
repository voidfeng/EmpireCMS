...
</td></tr><tr><td bgcolor=ffffff>软件简介</td><td bgcolor=ffffff><textarea name="softsay" cols="80" rows="10" id="softsay"><?=$ecmsfirstpost==1?"":DoRehValue($modid,'softsay',stripSlashes($r['softsay']))?></textarea>
</td></tr>