...
</td></tr><tr><td bgcolor=ffffff>文件大小</td><td bgcolor=ffffff><input name="filesize" type="text" id="filesize" value="<?=$ecmsfirstpost==1?"":DoRehValue($modid,'filesize',stripSlashes($r['filesize']))?>" size="60">
<select name="select" onchange="document.add.filesize.value+=this.value">
      ...
      </select></td></tr><tr><td bgcolor=ffffff>图片尺寸</td><td bgcolor=ffffff><input name="picsize" type="text" id="picsize" value="<?=$ecmsfirstpost==1?"":DoRehValue($modid,'picsize',stripSlashes($r['picsize']))?>" size="">
</td></tr><tr><td bgcolor=ffffff>图片分辨率</td><td bgcolor=ffffff><input name="picfbl" type="text" id="picfbl" value="<?=$ecmsfirstpost==1?"":DoRehValue($modid,'picfbl',stripSlashes($r['picfbl']))?>" size="">
</td></tr><tr><td bgcolor=ffffff>来源</td><td bgcolor=ffffff><input name="picfrom" type="text" id="picfrom" value="<?=$ecmsfirstpost==1?"":DoRehValue($modid,'picfrom',stripSlashes($r['picfrom']))?>" size="60">
...
</td></tr><tr><td bgcolor=ffffff>图片大图</td><td bgcolor=ffffff><input name="picurl" type="text" id="picurl" value="<?=$ecmsfirstpost==1?"":DoRehValue($modid,'picurl',stripSlashes($r['picurl']))?>" size="45">
<a onclick="window.open('ecmseditor/FileMain.php?type=1&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=picurl<?=$ecms_hashur['ehref']?>','','width=700,height=550,scrollbars=yes');" title="选择已上传的图片"><img src="../../e/data/images/changeimg.gif" border="0" align="absbottom"></a> 
...
</td></tr><tr><td bgcolor=ffffff>每行显示条数</td><td bgcolor=ffffff><input name="num" type="text" id="num" value="<?=$ecmsfirstpost==1?"3":DoRehValue($modid,'num',stripSlashes($r['num']))?>" size="">
</td></tr><tr><td bgcolor=ffffff>缩图宽度</td><td bgcolor=ffffff><input name="width" type="text" id="width" value="<?=$ecmsfirstpost==1?"":DoRehValue($modid,'width',stripSlashes($r['width']))?>" size="6">
</td></tr><tr><td bgcolor=ffffff>缩图高度</td><td bgcolor=ffffff><input name="height" type="text" id="height" value="<?=$ecmsfirstpost==1?"":DoRehValue($modid,'height',stripSlashes($r['height']))?>" size="6">
</td></tr><tr><td bgcolor=ffffff>图片简介</td><td bgcolor=ffffff><textarea name="picsay" cols="80" rows="10" id="picsay"><?=$ecmsfirstpost==1?"":DoRehValue($modid,'picsay',stripSlashes($r['picsay']))?></textarea>
</td></tr>