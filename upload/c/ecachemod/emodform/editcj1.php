...
</td></tr><tr><td bgcolor=ffffff>新闻正文</td><td bgcolor=ffffff><?=ECMS_ShowEditorVar("newstext",$ecmsfirstpost==1&&$usersldo==0?"":DoRehValue($modid,'newstext',stripSlashes($r['newstext'])),"Default","","300","100%")?>
