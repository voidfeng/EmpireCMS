...
<a onclick="window.open('ecmseditor/FileMain.php?type=1&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=titlepic<?=$ecms_hashur['ehref']?>','','width=700,height=550,scrollbars=yes');" title="选择已上传的图片"><img src="../../e/data/images/changeimg.gif" border="0" align="absbottom"></a> 
  ...
  <tr> 
    ...
    <td bgcolor=ffffff><input name="softwriter" type="text" id="softwriter" value="<?=$ecmsfirstpost==1?"":DoRehValue($modid,'softwriter',stripSlashes($r['softwriter']))?>" size="60">
</td>
  </tr>
  <tr> 
    <td width=16% height=25 bgcolor=ffffff>厂商主页</td>
    <td bgcolor=ffffff><input name="homepage" type="text" id="homepage" value="<?=$ecmsfirstpost==1?"http://":DoRehValue($modid,'homepage',stripSlashes($r['homepage']))?>" size="60">
</td>
  </tr>
  <tr> 
    <td width=16% height=25 bgcolor=ffffff>系统演示</td>
    <td bgcolor=ffffff><input name="demo" type="text" id="demo" value="<?=$ecmsfirstpost==1?"http://":DoRehValue($modid,'demo',stripSlashes($r['demo']))?>" size="60">
</td>
  </tr>
  <tr> 
    <td width=16% height=25 bgcolor=ffffff>运行环境</td>
    <td bgcolor=ffffff><input name="softfj" type="text" id="softfj" value="<?=$ecmsfirstpost==1?"":DoRehValue($modid,'softfj',stripSlashes($r['softfj']))?>" size="60">
</td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td bgcolor=ffffff>文件类型：<input name="filetype" type="text" id="filetype" value="<?=$ecmsfirstpost==1?"":DoRehValue($modid,'filetype',stripSlashes($r['filetype']))?>" size="">
<select name="select2" onchange="document.add.filetype.value=this.value">
        <option value="">类型</option>
        <option value=".zip">.zip</option>
        <option value=".rar">.rar</option>
        <option value=".exe">.exe</option>
      </select>，文件大小：<input name="filesize" type="text" id="filesize" value="<?=$ecmsfirstpost==1?"":DoRehValue($modid,'filesize',stripSlashes($r['filesize']))?>" size="">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td bgcolor=ffffff><textarea name="softsay" cols="80" rows="10" id="softsay"><?=$ecmsfirstpost==1?"":DoRehValue($modid,'softsay',stripSlashes($r['softsay']))?></textarea>
</td>
  </tr>
</table>