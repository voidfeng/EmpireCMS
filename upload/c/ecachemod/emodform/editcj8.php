...
</td></tr><tr><td bgcolor=ffffff>信息内容</td><td bgcolor=ffffff><textarea name="smalltext" cols="80" rows="10" id="smalltext"><?=$ecmsfirstpost==1?"":DoRehValue($modid,'smalltext',stripSlashes($r['smalltext']))?></textarea>
...
</td></tr><tr><td bgcolor=ffffff>联系方式</td><td bgcolor=ffffff><input name="mycontact" type="text" id="mycontact" value="<?=$ecmsfirstpost==1?"":DoRehValue($modid,'mycontact',stripSlashes($r['mycontact']))?>" size="60">
</td></tr><tr><td bgcolor=ffffff>联系地址</td><td bgcolor=ffffff><input name="address" type="text" id="address" value="<?=$ecmsfirstpost==1?$memberinfor['address']:DoRehValue($modid,'address',stripSlashes($r['address']))?>" size="60">
</td></tr>