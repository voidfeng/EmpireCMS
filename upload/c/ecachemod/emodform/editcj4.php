...
</td></tr><tr><td bgcolor=ffffff>作者</td><td bgcolor=ffffff><input name="flashwriter" type="text" id="flashwriter" value="<?=$ecmsfirstpost==1?"":DoRehValue($modid,'flashwriter',stripSlashes($r['flashwriter']))?>" size="60">
</td></tr><tr><td bgcolor=ffffff>作者邮箱</td><td bgcolor=ffffff><input name="email" type="text" id="email" value="<?=$ecmsfirstpost==1?"":DoRehValue($modid,'email',stripSlashes($r['email']))?>" size="60">
</td></tr><tr><td bgcolor=ffffff>作品评价</td><td bgcolor=ffffff><select name="star" id="star"><option value="1"<?=$r['star']=="1"?' selected':''?>>1星</option><option value="2"<?=$r['star']=="2"||$ecmsfirstpost==1?' selected':''?>>2星</option><option value="3"<?=$r['star']=="3"?' selected':''?>>3星</option><option value="4"<?=$r['star']=="4"?' selected':''?>>4星</option><option value="5"<?=$r['star']=="5"?' selected':''?>>5星</option></select></td></tr><tr><td bgcolor=ffffff>文件大小</td><td bgcolor=ffffff><input name="filesize" type="text" id="filesize" value="<?=$ecmsfirstpost==1?"":DoRehValue($modid,'filesize',stripSlashes($r['filesize']))?>" size="60">
<select name="select" onchange="document.add.filesize.value+=this.value">
      ...
      </select></td></tr><tr><td bgcolor=ffffff>Flash地址</td><td bgcolor=ffffff><input name="flashurl" type="text" id="flashurl" value="<?=$ecmsfirstpost==1?"":DoRehValue($modid,'flashurl',stripSlashes($r['flashurl']))?>" size="45">
...
</td></tr><tr><td bgcolor=ffffff>Flash宽度</td><td bgcolor=ffffff><input name="width" type="text" id="width" value="<?=$ecmsfirstpost==1?"600":DoRehValue($modid,'width',stripSlashes($r['width']))?>" size="6">
</td></tr><tr><td bgcolor=ffffff>Flash高度</td><td bgcolor=ffffff><input name="height" type="text" id="height" value="<?=$ecmsfirstpost==1?"450":DoRehValue($modid,'height',stripSlashes($r['height']))?>" size="6">
</td></tr><tr><td bgcolor=ffffff>作品简介</td><td bgcolor=ffffff><textarea name="flashsay" cols="80" rows="10" id="flashsay"><?=$ecmsfirstpost==1?"":DoRehValue($modid,'flashsay',stripSlashes($r['flashsay']))?></textarea>
</td></tr>