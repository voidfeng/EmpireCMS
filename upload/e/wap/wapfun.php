...
function DoWapIconvVal($str){
	...
	if($ecms_config['sets']['pagechar']!='utf-8')
	{
		...
		$str=DoIconvVal($char,$targetchar,$str);
	}
	return $str;
}
...
$pr=$empire->fetch1("select sitekey,siteintro,wapopen,wapdefstyle,wapshowmid,waplistnum,wapsubtitle,wapshowdate,wapchar,wapchstyle from {$dbtbpre}enewspublic".do_dblimit_one());
