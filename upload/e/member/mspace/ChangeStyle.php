...
$user=islogin();
$addr=$empire->fetch1("select spacestyleid from {$dbtbpre}enewsmemberadd where userid='".$user['userid']."'".do_dblimit_one());
...
$query.=" order by styleid".do_dblimit($line,$offset);
$returnpage=page1($num,$line,$page_line,$start,$page,$search);
//导入模板
include(ECMS_PATH.'e/template/member/mspace/ChangeStyle.php');
db_close();
$empire=null;
?>