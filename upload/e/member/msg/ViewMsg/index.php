...
$r=$empire->fetch1("select mid,title,msgtext,from_userid,from_username,msgtime,haveread,issys from {$dbtbpre}enewsqmsg where mid='$mid' and to_username='".$user['username']."'".do_dblimit_one());
if(empty($r['mid']))
{
	printerror("HaveNotMsg","",1);
}
...
//导入模板
include(ECMS_PATH.'e/template/member/ViewMsg.php');
db_close();
$empire=null;
?>