...
$public_r['rssnum']=(int)$public_r['rssnum'];
$query="select ".ReturnSqlListF($mid)." from {$dbtbpre}ecms_".$tbname.ReturnYhAndSql($yhadd,$add,1)." order by ".$myorder." ".$myorderby."".do_dblimit($public_r['rssnum']);
$sublen=(int)$public_r['rsssub'];
