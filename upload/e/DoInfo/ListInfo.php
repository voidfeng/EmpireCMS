...
//导入页面
$mr['listfile']=(int)$mr['listfile'];
$deftempfile=ECMS_PATH.'c/ecachemod/emodlist/1/qlistinfo.php';
if($mr['listfile'])
{
	$tempfile=ECMS_PATH.'c/ecachemod/emodlist/'.$mr['listfile'].'/qlistinfo.php';
