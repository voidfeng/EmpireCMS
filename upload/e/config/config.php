...
$ecms_config['db']['dbname']='ecms8db';	//数据库名
...
$ecms_config['db']['dbtbtype']=0;	//数据表引擎，0为MYISAM、1为INNODB
...
$ecms_config['esafe']['hfadminpath']='eadmin';	//后台一级目录名，修改一级目录名后需修改这里，而二级目录admin可任意重命名，不需要其它设置
$ecms_config['esafe']['hclosemods']='';	//后台关闭相关模块，多个用逗号隔开，比如：,ebak,dosql,loadinmod,
$ecms_config['esafe']['ckffbasepath']=ECMS_PATH.'c/ecacheadmin/eadminloginfile/';	//后台认证文件存放目录
$ecms_config['esafe']['ckffcantype']='|.txt|.jpg|.gif|.png|.jpeg|.bmp|.mp3|.mp4|';	//后台上传认证文件允许扩展名
$ecms_config['esafe']['ckffmaxsize']=500;	//后台上传认证文件最大大小，单位KB
$ecms_config['esafe']['ckfftmpbasepath']=ECMS_PATH.'d/etmpadmin/eckadminloginfile/';	//后台认证文件上传临时目录(不需要执行权限)
$ecms_config['esafe']['ckfftmpfiletype']='.txt';	//后台认证文件上传临时文件扩展名
...
$ecms_config['sets']['printerrortype']=0;	//提示信息格式(json格式可设为1)
...
$ecms_config['member']['saltnum']=-6;//SALT随机码字符数(负数为随机最小数)
...
$ecms_config['memberf']['rndt']='rndt';//随机密码字段2
$ecms_config['memberf']['email']='email';//邮箱字段
$ecms_config['memberf']['phno']='phno';//手机号码字段
$ecms_config['memberf']['upic']='upic';//头像字段
...
$ecms_config['memberf']['userjyz']='userjyz';//经验值字段
$ecms_config['memberf']['usertitle']='usertitle';//头衔字段
...
$ecms_config['memberf']['isot']='isot';//退出状态字段
$ecms_config['memberf']['mustdo']='mustdo';//必须操作状态字段
...
$ecms_config['esafe']['eloginurlcsvar']='id';	//后台登录地址验证参数变量名(不设置为id)
$ecms_config['esafe']['eloginurlcs']='';	//后台登录地址验证参数(空为不开启)
$ecms_config['esafe']['ecertotime']=1800;	//登录证书发送数据有效时间,单位:秒
$ecms_config['esafe']['ecookiernd']='www.phome.net';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['esafe']['loginonepass']=0;	//后台开启一次性密码登录,0为关闭,1为开启
...
$ecms_config['esafe']['ckformhash']=0;	//启用后台表单独立来源认证码,0为开启,1为关闭
$ecms_config['esafe']['ckhuseragent']='';	//允许后台访问的UserAgent信息必须包含字符(区分大小写),多个用“||”半角双竖线隔开
$ecms_config['esafe']['hendatakey']='www.phome.net';	//后台数据加密组合字符串(填写30~70个任意字符)
$ecms_config['esafe']['endatakey']='www.phome.net';		//前台数据加密组合字符串(填写30~70个任意字符)
$ecms_config['esafe']['viewpassvar']='empirecmsvar';	//整站访问密码验证变量名(由字母和数字组成)
$ecms_config['esafe']['viewpass']='';					//整站访问密码，空为不设置
$ecms_config['esafe']['hviewpassvar']='empirecmsvar2';	//后台访问密码验证变量名(由字母和数字组成)
$ecms_config['esafe']['hviewpass']='';					//后台访问密码，空为不设置

//COOKIE设置
$ecms_config['cks']['ckdomain']='';		//cookie作用域
$ecms_config['cks']['ckpath']='/';		//cookie作用路径
$ecms_config['cks']['ckadmindomain']='';	//后台cookie作用域
$ecms_config['cks']['ckadminpath']='/';		//后台cookie作用路径
...
$ecms_config['fw']['adminloginurl']='';	//允许后台登陆的域名,设置后必须通过这个域名才能访问后台(多个域名可以用“||”分隔)
...
'delnewsnum'=>300,
'markpos'=>5,
'markimg'=>'d/efilepub/emark/maskdef.gif',
'marktext'=>'',
'markfontsize'=>'5',
'markfontcolor'=>'',
'markfont'=>'d/efilepub/emark/cour.ttf',
'adminloginkey'=>1,
'php_outtime'=>0,
...
'hopenip'=>'',
'textpagelistnum'=>6,
'memberlistlevel'=>-99999999,
'ebakcanlistdb'=>0,
'keytog'=>2,
'keytime'=>900,
'keyrnd'=>'xVQVPTSfkWgPvxv8Yy4YXgavP5xLo0pP',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/ecms80/news/\">新闻中心</a>&nbsp;|&nbsp;<a href=\"/ecms80/download/\">下载中心</a>&nbsp;|&nbsp;<a href=\"/ecms80/movie/\">影视频道</a>&nbsp;|&nbsp;<a href=\"/ecms80/shop/\">网上商城</a>&nbsp;|&nbsp;<a href=\"/ecms80/flash/\">FLASH频道</a>&nbsp;|&nbsp;<a href=\"/ecms80/photo/\">图片频道</a>&nbsp;|&nbsp;<a href=\"/ecms80/article/\">文章中心</a>&nbsp;|&nbsp;<a href=\"/ecms80/info/\">分类信息</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'openfileserver'=>0,
'fs_purl'=>'',
'closemods'=>',shop,pay,rss,search,sch,downfile,error,pl,mconnect,fieldand,gb,fb,mlist,api,dtup,',
'fieldandtop'=>0,
'fieldandclosetb'=>'',
'filedatatbs'=>',1,',
'filedeftb'=>1,
...
'bakescapetype'=>1,
'hkeytime'=>30,
'hkeyrnd'=>'nh44AZmeIo7BWGLZsshKRklsPKHEjz6xEE45',
'mhavedatedo'=>0,
'reportkey'=>0,
'ctimeopen'=>0,
'ctimelast'=>0,
...
'ctimegids'=>'',
'ctimecids'=>'',
'ctimernd'=>'QSBPkSqxgIUNhojfN5O0xSUO2cTmOUziPy2vklPMtL',
'qmadminuids'=>'',
'qmforumuids'=>'',
'qmotheruids'=>'',
'ckhavemoreport'=>0,
...
'upicsize'=>50,
'upictype'=>'|.jpg|',
'upicdef'=>'/ecms80/e/data/images/nouserpic.gif',
'tfilechmod'=>0,
'fpnpub'=>'efpub',
'eaopenpage'=>0,
'eackrnd'=>'Q7k8B4hhgLOGAZg5e9rFQMCkUPFK2tPwbVYXWmB6XOprYPhMuDC4vvgmiiBrwF',
'eacktime'=>120,
'drretype'=>0,
'drrepage'=>'',
'qedtext'=>1,
...
'phmreg'=>0,
'phmckst'=>0,
'phmckrnd'=>'InxxlFAJ7eWv7AJG72RFfF9LnuGxHJN0vSORSm2HptrGBi',
'phmlgtoreg'=>0,
'phmdo'=>'',
'openipf'=>0,
'openbqr'=>0,
...
$emod_pubr=Array('linkfields'=>'|','alltbs'=>',news,download,photo,flash,movie,shop,article,info,','alltbids'=>',1,2,3,4,5,6,7,8,','allmids'=>',1,2,3,4,5,6,7,8,','fieldchids'=>'|','tbidseo'=>',','tbidsed'=>',');
...
$etable_t=array();
$etable_t['1']=Array('tbname'=>'news');
$etable_t['2']=Array('tbname'=>'download');
$etable_t['3']=Array('tbname'=>'photo');
$etable_t['4']=Array('tbname'=>'flash');
$etable_t['5']=Array('tbname'=>'movie');
$etable_t['6']=Array('tbname'=>'shop');
$etable_t['7']=Array('tbname'=>'article');
$etable_t['8']=Array('tbname'=>'info');
