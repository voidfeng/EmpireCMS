...
else
{
	...
	$n_r=$empire->fetch1("select * from {$dbtbpre}ecms_".$class_r[$classid]['tbname']." where id='$id'".do_dblimit_one());
...
$line=(int)$public_r['pl_num'];//每页显示记录数
...
$tempid=(int)$tempid;
@include(ECMS_PATH.'c/ecachetemp/epltemp/pl'.$tempid.'.php');
db_close();
$empire=null;
?>