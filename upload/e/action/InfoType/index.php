...
$ttr=$empire->fetch1("select typeid,tname,mid,yhid,tnum,listtempid,tpath,ttype,maxnum,reorder,tid,tbname,timg,intro,pagekey,listdt,repagenum,fclast,ecmsvpf from {$dbtbpre}enewsinfotype where typeid='$ttid'");
$tbname=$ttr['tbname'];
