...
(
	...
	'ckfQEmptyFile'=>'请选择要上传的认证文件',
	'ckfQFiletypeFail'=>'文件扩展名有误',
	'ckfQErrorFile'=>'认证文件错误',
	...
	'LessPassword'=>'密码不能少于8位',
	'EditPasswordSuccess'=>'修改资料成功',
	'EditPasswordSuccessLogin'=>'修改资料成功,改变操作界面需重新登录',
	'PasswordCharLess'=>'密码不能少于8位',
	'PasswordCharSz'=>'密码必须包含至少一个数字',
	'PasswordCharZm'=>'密码必须包含至少一个字母',
	'PasswordCharDzm'=>'密码必须包含至少一个大写字母',
	'PasswordCharTs'=>'密码必须包含至少一个特殊字符',
	'PasswordTsOld'=>'您的密码已过期，请立即修改密码',
	...
	'ckfEmptyFile'=>'请选择要上传的认证文件',
	'ckfFiletypeFail'=>'文件扩展名有误',
	'ckfFilesizeFail'=>'文件过大',
	'ckfFiletextFail'=>'文件内容不能为空',
	'ckfFileFail'=>'请查看目录权限是否为0777,文件上传不成功',
	'ckfNoCertFile'=>'您还没绑定过认证文件',
	'DoCertFileSuccess'=>'认证文件设置成功',
	'CloseCertFileSuccess'=>'已取消认证文件绑定',
	'HaveDoEnpassFile'=>'已经启用过',
	'NoDoEnpassFile'=>'您没有启用过',
	'CloseEnpassFileSuccess'=>'取消成功',
	'EmptyUserOnePass'=>'请输入识别码和密码',
	'ReUserOnePassPno'=>'识别码已存在',
	'AddUserOnePassSuccess'=>'增加一次性密码成功',
	'EditUserOnePassSuccess'=>'修改一次性密码成功',
	'NotDelUserOnePassid'=>'请选择要删除的一次性密码',
	...
	'EapageOutTime'=>'验证信息已过期',
	'EapageErrorPass'=>'验证信息不正确',
	...
	'SetEcmsMoreSuccess'=>'设置成功',
	'DoDayUpRndMustSuccess'=>'更新天天随机验证字符成功',
	...
	'EditFileAllSuccess'=>'修改文件别名成功',
	'EmptyFileClass'=>'请输入分类名称',
	'AddFileClassSuccess'=>'增加分类成功',
	'EditFileClassSuccess'=>'修改分类成功',
	'NotDelFileClassid'=>'请选择要删除的分类',
	'DelFileClassSuccess'=>'删除分类成功',
	'EditFileOneSuccess'=>'修改附件成功',
	...
	'EmptyModList'=>'请输入列表名称',
	'AddModListSuccess'=>'增加系统模型列表成功',
	'EditModListSuccess'=>'修改系统模型列表成功',
	'NotChangeModList'=>'请选择要删除的列表',
	'NotDelDefaultModList'=>'默认列表不可删除',
	'DelModListSuccess'=>'删除系统模型列表成功',
	...
	'EmptySearchUrl'=>'请输入搜索词和地址',
	'AddSearchUrlSuccess'=>'增加搜索转发成功',
	'EditSearchUrlSuccess'=>'修改搜索转发成功',
	'NotChangeSearchUrlid'=>'请选择要删除的搜索转发',
	'DelSearchUrlSuccess'=>'删除搜索转发成功',
	'EmptyDtUserpageClass'=>'请输入分类名称',
	'AddDtUserpageClassSuccess'=>'增加分类成功',
	'EditDtUserpageClassSuccess'=>'修改分类成功',
	'NotDelDtUserpageClassid'=>'请选择要删除的分类',
	'DelDtUserpageClassSuccess'=>'删除分类成功',
	'EmptyDtUserpageName'=>'请输入页面名称',
	'AddDtUserpageSuccess'=>'增加动态页面成功',
	'EditDtUserpageSuccess'=>'修改动态页面成功',
	'NotChangeDtUserpageid'=>'请选择要删除的页面',
	'DelDtUserpageSuccess'=>'删除动态页面成功',
	'ReDtUserpageAllSuccess'=>'批量更新自定义动态页面成功',
	...
	'EmptyFzinfoClassname'=>'请输入分类名',
	'AddFzinfoClassSuccess'=>'增加分类成功',
	'EditFzinfoClassSuccess'=>'修改分类成功',
	'NotChangeFzinfoClassid'=>'请选择要删除的分类',
	'DelFzinfoClassSuccess'=>'删除分类成功',
	...
	'AddPayApiSuccess'=>'增加接口成功',
	'NotDelPayApi'=>'请选择要删除的接口',
	'DelPayApiSuccess'=>'删除接口成功',
	'EmptySetPayFen'=>'点数不能设置为0',
	'SetPayFenSuccess'=>'支付参数设置完毕',

	'SetFirewallSuccess'=>'防火墙设置完毕',
	'SetFirewallSuccessLogin'=>'防火墙设置完毕,防火墙参数变更需重新登录',
	'SetSafeSuccess'=>'设置完毕',
	'SetSafeSuccessLogin'=>'设置完毕,安全参数变更需重新登录',
	...
	'EmptyFzinfo'=>'请选择要设置的信息',
	'ReFzinfo'=>'此信息已经是父信息',
	'AddFzinfoSuccess'=>'增加父信息成功',
	'EditFzinfoSuccess'=>'设置父信息参数成功',
	'NotDelFzinfoid'=>'请选择要取消的父信息',
	'DelFzinfoSuccess'=>'取消父信息成功',
	'EmptyFzDataClass'=>'请输入分类名称',
	'AddFzDataClassSuccess'=>'增加子信息分类成功',
	'EditFzDataClassSuccess'=>'修改子信息分类成功',
	'NotDelFzDataClassid'=>'请选择要删除的子信息分类',
	'DelFzDataClassSuccess'=>'删除子信息分类成功',
	'EditFzDataClassOrderSuccess'=>'修改子信息分类顺序成功',
	'EmptyFzDataZid'=>'请选择子信息',
	'DelFzDataSuccess'=>'移除子信息成功',
	'EmptyMoveFzDataCid'=>'请选择目标子类',
	'MoveFzDataSuccess'=>'转移子信息成功',
	'GoodFzDataSuccess'=>'推荐/取消推荐子信息成功',
	'FirsttitleFzDataSuccess'=>'头条/取消头条子信息成功',
	'EditFzDataTimeSuccess'=>'批量修改子信息发布时间成功',
	'LoadInFzDataSuccess'=>'推送子信息成功',
	'EmptyFzDataTable'=>'请输入表名',
	'ReFzDataTable'=>'表已存在',
	'AddFzDataTableSuccess'=>'增加子信息分表成功',
	'NotChangeFzDataTable'=>'请选择分表',
	'DefFzDataTableSuccess'=>'默认存放分表成功',
	'NotDelDefFzDataTable'=>'默认分表不能删除',
	'DelFzDataTableSuccess'=>'删除子信息分表成功',
	'ClearFzinfoSuccess'=>'整理父子信息数据完毕',
	
	'SetApiSuccess'=>'设置成功',
	'EmptyApiClass'=>'请输入分类名称',
	'AddApiClassSuccess'=>'增加分类成功',
	'EditApiClassSuccess'=>'修改分类成功',
	'NotChangeApiClassid'=>'请选择要删除的分类',
	'DelApiClassSuccess'=>'删除分类成功',
	'EmptyApi'=>'请输入接口名称',
	'AddApiSuccess'=>'增加接口成功',
	'EditApiSuccess'=>'修改接口成功',
	'NotChangeApiId'=>'请选择要删除的接口',
	'DelApiSuccess'=>'删除接口成功',
	'ReApiSuccess'=>'更新接口成功',
	'ChangeApiCacheSuccess'=>'更新缓存成功',
