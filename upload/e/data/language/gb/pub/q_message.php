...
$qmessage_r=array(
	...
	'NewMemberAddPlError'=>'系统限制新注册会员 '.$public_r['plnewaddtime'].' 分钟后才能评论',
	...
	'FailMgSetPs'=>'认证码不对',
	'EmptyMember'=>'用户名，密码不能为空',
	'EmptyMemberEmail'=>'邮箱不能为空',
	'EmptyMemberPhno'=>'手机不能为空',
	'EmptyMemberMF'=>'邮箱、手机不能为空',
	'FaiUserlen'=>'用户名长度有误',
	...
	'PhmClose'=>'手机接口已关闭',
	'PhmDayMax'=>'今日短信总数已用完',
	'PhmOneMax'=>'您的今日短信数量已用完',
	'PhmRetime'=>'短信发送时间间隔过短',
	'PhmNotPhno'=>'该手机号没有绑定过',
	'PhmErrorKey'=>'验证码错误或已失效',
	'phmOutFKeytime'=>'表单验证码过期，请重新刷新页面',
	'phmFailFKey'=>'表单验证码过期，请重新刷新页面',

	'ReBindPhno'=>'此手机号码已绑定过',
	'BindPhSuccess'=>'绑定成功',
	'DelBindPhSuccess'=>'已取消绑定',
	'PhmRegClose'=>'网站关闭短信注册',
	'PhmLoginClose'=>'网站关闭短信登录',
	'PhmBindClose'=>'网站关闭手机绑定',
	'PhmDelbClose'=>'网站关闭取消手机绑定',
	'PhmRegRePhno'=>'此手机号码已注册过',
	
	'CloseFzPage'=>'此页面没有开启',
	'CloseFzPageC'=>'此分类没有开启',

	'NotChMTempid'=>'指定的模板不对',
	'CloseTags'=>'TAG功能已关闭',
	'HaveNotTags'=>'此TAG不存在',
);
?>