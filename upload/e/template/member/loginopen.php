...
<body>
  ...
  <form name="form1" method="post" action="../doaction.php">
    ...
    <tr bgcolor="#FFFFFF"> 
      <td height="25">&nbsp;</td>
      <td height="25"><input type="submit" name="Submit" value=" 登 录 "> &nbsp;&nbsp;&nbsp;
      <input type="button" name="button" value="注册" onclick="window.open('../register/');"></td>
    </tr>
	<?php
	if($public_r['phmopen'])
	{
    ...
    <tr bgcolor="#FFFFFF">
      <td height="25">&nbsp;</td>
      <td height="25"><div align="right"><font color="#666666">[<a href="../../extenddef/esms/BindPhLoginOpen.php?prtype=<?=ehtmlspecialchars($_GET['prt'])?>&ecmsfrom=<?=urlencode(ehtmlspecialchars($_GET['from']))?>">切换到短信验证码登录</a>]</font></div></td>
    </tr>
	<?php
	}
	?>
