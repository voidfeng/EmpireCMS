...
?>
	...
	{
		if(empty($class_r[$r['classid']]['tbname'])||InfoIsInTable($class_r[$r['classid']]['tbname']))
		{continue;}
		$nr=$empire->fetch1("select title,isurl,titleurl,classid from {$dbtbpre}ecms_".$class_r[$r['classid']]['tbname']." where id='".$r['id']."'".do_dblimit_one());
		//标题链接
