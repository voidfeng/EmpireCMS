...
if($tobind)
{
	$loginurladdcs='?tobind=1';
}
if($_GET['from'])
{
	$loginurladdcs.=($loginurladdcs?'&':'?').'ecmsfrom='.urlencode(ehtmlspecialchars($_GET['from']));
}
...
<input type=radio name=lifetime value=315360000>
    ...
    <tr bgcolor="#FFFFFF">
      <td height="25">&nbsp;</td>
      <td height="25"><div align="right"><font color="#666666">[<a href="../../extenddef/esms/BindPhLogin.php<?=$loginurladdcs?>">切换到短信验证码登录</a>]</font></div></td>
    </tr>
	<?php
	}
	?>
