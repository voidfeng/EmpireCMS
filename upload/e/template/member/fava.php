      ...
      <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
        ...
        <table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableborder">
          <form name=favaform method=post action="../doaction.php" onsubmit="return confirm('确认要操作?');">
			...
			{
				if(empty($class_r[$fr['classid']]['tbname'])||InfoIsInTable($class_r[$fr['classid']]['tbname']))
				{continue;}
				$r=$empire->fetch1("select title,isurl,titleurl,onclick,classid,id from {$dbtbpre}ecms_".$class_r[$fr['classid']]['tbname']." where id='".$fr['id']."'".do_dblimit_one());
				//标题链接
