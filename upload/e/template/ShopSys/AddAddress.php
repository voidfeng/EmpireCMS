...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
  <form action="../doaction.php" method="post" name="addform" id="addform">
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td width="78%" height="25"><input name="addressname" type="text" id="addressname" value="<?=stripSlashes($r['addressname'])?>" size="42">
      *</td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td height="25">姓名：</td>
      <td height="25"><input name="truename" type="text" id="truename" value="<?=stripSlashes($r['truename'])?>" size="42"></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td height="25">邮箱地址：</td>
      <td height="25"><input name="email" type="text" id="email" value="<?=stripSlashes($r['email'])?>" size="42"></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td height="25">固定电话：</td>
      <td height="25"><input name="mycall" type="text" id="mycall" value="<?=stripSlashes($r['mycall'])?>" size="42"></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td height="25">联系手机：</td>
      <td height="25"><input name="phone" type="text" id="phone" value="<?=stripSlashes($r['phone'])?>" size="42"></td>
    </tr>
    <tr bgcolor="#FFFFFF">
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td height="25"><input name="address" type="text" id="address" value="<?=stripSlashes($r['address'])?>" size="42"></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td height="25">邮编：</td>
      <td height="25"><input name="zip" type="text" id="zip" value="<?=stripSlashes($r['zip'])?>" size="42"></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td height="25">地址周边标志性建筑：</td>
      <td height="25"><input name="signbuild" type="text" id="signbuild" value="<?=stripSlashes($r['signbuild'])?>" size="42"></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td height="25">最佳收货时间：</td>
      <td height="25"><input name="besttime" type="text" id="besttime" value="<?=stripSlashes($r['besttime'])?>" size="42"></td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td height="25">&nbsp;</td>
