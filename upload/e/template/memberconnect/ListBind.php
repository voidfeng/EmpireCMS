...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="tableborder">
  ...
  {
	  $bindr=$empire->fetch1("select id,bindtime,loginnum,lasttime from {$dbtbpre}enewsmember_connect where userid='".$user['userid']."' and apptype='".$r['apptype']."'".do_dblimit_one());
	  if($bindr['id'])
	  {
