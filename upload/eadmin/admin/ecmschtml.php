...
//level
if($enews=='ReListHtml_all'||$enews=='ReNewsHtml'||$enews=='ReAllNewsJs'||$enews=='ReDtPage'||$enews=='ReTtListHtml_all'||$enews=='ReZtListHtml_all'||$enews=='ReSpAll'||$enews=='ReClassPath'||$enews=='UpdgxClassInfosAll'||$enews=='ReUserpageAll'||$enews=='ReUserlistAll'||$enews=='ReUserjsAll'||$enews=='GoReListHtmlMore'||$enews=='GoReListHtmlMoreA'||$enews=='ReListHtmlMore'||$enews=='ReListZtHtmlMore'||$enews=='ReListTtHtmlMore'||$enews=='ReDtUserpageAll')
{
...
elseif($enews=='UpdgxClassInfosAll')//更新栏目信息数
{
	UpdateClassInfosAll($_GET);
}
elseif($enews=="ReDtUserpageAll")//批量刷新自定义动态页面
{
	ReDtUserpageAll($_GET['start'],$_GET['from'],$logininid,$loginin);
}
else
{
