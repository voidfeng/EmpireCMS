...
elseif($enews=="AddModList")//增加系统模型列表
{
	AddModList($_POST,$logininid,$loginin);
}
elseif($enews=="EditModList")//修改系统模型列表
{
	EditModList($_POST,$logininid,$loginin);
}
elseif($enews=="DelModList")//删除系统模型列表
{
	$lid=$_GET['lid'];
	DelModList($lid,$logininid,$loginin);
}
else
