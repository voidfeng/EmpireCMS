...
function eCheckInstallFile(){
	...
	{
		echo'<br><div align="center"><font color="#FF0000"><strong>温馨提示：您的安装程序目录“/e/install/”还没有删除，请您删除安装程序目录以免被重复安装，谢谢！</strong></font></div><br><br>';
		//exit();
	}
}
...
$empirecmsckeyrnd='';
$empirecmsckeytime='';
if($_POST['empirecmskey1']&&$_POST['empirecmskey2']&&$_POST['empirecmskey3']&&$_POST['empirecmskey4']&&$_POST['empirecmskey5']&&$_POST['empirecmsckeyrnd']&&$_POST['empirecmsckeytime'])
{
	...
	$ecertkeyrndstr=$empirecmskey1.'#!#'.$empirecmskey2.'#!#'.$empirecmskey3.'#!#'.$empirecmskey4.'#!#'.$empirecmskey5.'#!#'.$empirecmsckeyrnd.'#!#'.$empirecmsckeytime;
...
elseif(getcvar('ecertkeyrnds'))
{
	...
	$empirecmsckeyrnd=RepPostVar($certr[5]);
	$empirecmsckeytime=(int)$certr[6];
}
else
{}
...
$ckid=CkPostStrIsArray($_GET[$ckidcsvar]);
$ckid=ehtmlspecialchars($ckid,ENT_QUOTES);
$aloginurlcs='';
if($ckid&&$ckid!='array')
{
	$aloginurlcs='?'.$ckidcsvar.'='.urlencode($ckid);
}
...
<table width="524" border="0" cellspacing="0" cellpadding="0" align="center" height="320">
  <form action="ecmsadmin.php<?php echo $aloginurlcs;?>" method="post" enctype="multipart/form-data" name="login" id="login" onSubmit="return CheckLogin(document.login);" autocomplete="off">
    ...
    <tr> 
      ...
      <td width="157" rowspan="2" valign="top" bgcolor="#FFFFFF"> 
        <table width="157" height="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="100%" valign="bottom"> <div align="right"><a href="../../" target="_blank"><img src="loginimg/homepage.gif" width="79" height="21" border="0"></a>&nbsp;<a href="http://www.phome.net/support/" target="_blank"><img src="loginimg/empirebbs.gif" width="69" height="21" border="0"></a></div></td>
          </tr>
        </table> </td>
    ...
    <tr> 
      <td height="80"> <table width="230" height="100%" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr> 
            ...
            <td colspan="2"> <input name="username" type="text" class="b-form2" size="22">            </td>
          </tr>
          <tr> 
            <td height="27">密&nbsp; &nbsp;码</td>
            <td colspan="2"> <input name="password" type="password" class="b-form2" size="22">            </td>
          </tr>
		  <?php
		  if($ecms_config['esafe']['loginonepass'])
		  {
		  ?>
		  <tr id="onepasspnoid" style="display:none"> 
            <td width="50" height="27" title="一次性密码识别码">识别码</td>
            <td colspan="2">
			<input name="onepasspno" type="text" class="b-form2" size="22">
			</td>
          </tr>
		  <tr> 
            <td width="50" height="27"></td>
            <td colspan="2">
			<input type="checkbox" name="useonepass" id="useonepass" onClick="if(this.checked){document.getElementById('onepasspnoid').style.display='';}else{document.getElementById('onepasspnoid').style.display='none';}" value="1">使用一次性密码
			</td>
          </tr>
		  <?php
		  }
      ...
      <td colspan="4"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="loginimg/login_r4_c1.gif">
          <tr> 
            ...
            <td width="302"><input name="empirecmskey1" type="hidden" id="empirecmskey1" value="<?php echo $empirecmskey1;?>">
			  ...
			  <input name="empirecmsckeyrnd" type="hidden" id="empirecmsckeyrnd" value="<?php echo $empirecmsckeyrnd;?>">
			  <input name="empirecmsckeytime" type="hidden" id="empirecmsckeytime" value="<?php echo $empirecmsckeytime;?>"></td>
          </tr>
        </table></td>
    </tr>
    <tr> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td width="73%" height="30">Powered by <a href="http://www.phome.net" target="_blank"><strong>EmpireCMS</strong></a> 
              <font color="#FF9900"><strong>8.0</strong></font> &copy; 2002-2025 <a href="http://www.phome.net" target="_blank">EmpireSoft</a> 
              Inc.</td>
            <td width="8%">&nbsp;</td>
          </tr>
        </table></td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="3">
  <tr>
    <td height="90"><div align="center"><a href="http://www.phome.net/EmpireBak/" target="_blank" title="EmpireBak+phpMyAdmin+高安全"><img src="loginimg/ebakbanner.gif" width="523" style="border:1px solid #63CDEF;"></a></div></td>
  </tr>
</table>
<script>
