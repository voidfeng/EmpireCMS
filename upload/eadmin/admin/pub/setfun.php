...
function ReturnSettingString($r){
	...
	$text=str_replace('[!@--do_eloginurlcsvar--@!]',addslashes($r['do_eloginurlcsvar']),$text);
	$text=str_replace('[!@--do_eloginurlcs--@!]',addslashes($r['do_eloginurlcs']),$text);
	$text=str_replace('[!@--do_ecertotime--@!]',intval($r['do_ecertotime']),$text);
	$text=str_replace('[!@--do_ecookiernd--@!]',addslashes($r['do_ecookiernd']),$text);
	$text=str_replace('[!@--do_loginonepass--@!]',intval($r['do_loginonepass']),$text);
	...
	$text=str_replace('[!@--do_ckformhash--@!]',intval($r['do_ckformhash']),$text);
	$text=str_replace('[!@--do_ckhuseragent--@!]',addslashes($r['do_ckhuseragent']),$text);
	$text=str_replace('[!@--do_hendatakey--@!]',addslashes($r['do_hendatakey']),$text);
    $text=str_replace('[!@--do_endatakey--@!]',addslashes($r['do_endatakey']),$text);
	$text=str_replace('[!@--do_viewpassvar--@!]',addslashes($r['do_viewpassvar']),$text);
	$text=str_replace('[!@--do_viewpass--@!]',addslashes($r['do_viewpass']),$text);
	$text=str_replace('[!@--do_hviewpassvar--@!]',addslashes($r['do_hviewpassvar']),$text);
	$text=str_replace('[!@--do_hviewpass--@!]',addslashes($r['do_hviewpass']),$text);
	//COOKIE
	...
	$text=str_replace('[!@--phome_cookieadmindomain--@!]',addslashes($r['phome_cookieadmindomain']),$text);
	$text=str_replace('[!@--phome_cookieadminpath--@!]',addslashes($r['phome_cookieadminpath']),$text);
...
function SetFirewall($add,$userid,$username){
	...
	$r['do_eloginurlcsvar']=$ecms_config['esafe']['eloginurlcsvar'];
	$r['do_eloginurlcs']=$ecms_config['esafe']['eloginurlcs'];
	$r['do_ecertotime']=$ecms_config['esafe']['ecertotime'];
	$r['do_ecookiernd']=$ecms_config['esafe']['ecookiernd'];
	$r['do_loginonepass']=$ecms_config['esafe']['loginonepass'];
	...
	$r['do_ckformhash']=$ecms_config['esafe']['ckformhash'];
	$r['do_ckhuseragent']=$ecms_config['esafe']['ckhuseragent'];
	$r['do_hendatakey']=$ecms_config['esafe']['hendatakey'];
	$r['do_endatakey']=$ecms_config['esafe']['endatakey'];
	$r['do_viewpassvar']=$ecms_config['esafe']['viewpassvar'];
	$r['do_viewpass']=$ecms_config['esafe']['viewpass'];
	$r['do_hviewpassvar']=$ecms_config['esafe']['hviewpassvar'];
	...
	$r['phome_cookieadmindomain']=$ecms_config['cks']['ckadmindomain'];
	$r['phome_cookieadminpath']=$ecms_config['cks']['ckadminpath'];
...
function SetSafe($add,$userid,$username){
	...
	if($add['loginauth'])
	{
		$r['do_loginauth']=$add['loginauth']=='null'?'':$add['loginauth'];
	}
	else
	{
		$r['do_loginauth']=$ecms_config['esafe']['loginauth'];
	...
	$r['do_eloginurlcs']=$add['eloginurlcs'];
	$r['do_ecertotime']=(int)$add['ecertotime'];
	$r['do_ecookiernd']=$add['ecookiernd'];
	$r['do_loginonepass']=(int)$add['loginonepass'];
	...
	$r['phome_cookieadmindomain']=$add['cookieadmindomain'];
	$r['phome_cookieadminpath']=$add['cookieadminpath'];
