...
//显示重复标题
if($openshowretitle==1&&$_GET['showretitle']==1)
{
...
//导入页面
$infomod_r['listfile']=(int)$infomod_r['listfile'];
$deftempfile=ECMS_PATH.'c/ecachemod/emodlist/1/listinfo.php';
if($infomod_r['listfile'])
{
	$tempfile=ECMS_PATH.'c/ecachemod/emodlist/'.$infomod_r['listfile'].'/listinfo.php';
