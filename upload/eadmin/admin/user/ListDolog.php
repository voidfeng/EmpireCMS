...
require "../../../e/data/".LoadLang("pub/enews.php");
...
$query="select logid,logip,logtime,username,enews,doing,ipport,userid from {$dbtbpre}enewsdolog".$where;
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
  <tr> 
    <td width="50%" height="32">位置：日志管理 &gt; <a href="ListDolog.php<?=$ecms_hashur['whehref']?>">管理操作日志</a></td>
    <td><div align="right" class="emenubutton">
        <input type="button" name="Submit5" value="管理登录日志" onclick="self.location.href='ListLog.php<?=$ecms_hashur['whehref']?>';">
      </div></td>
  </tr>
</table>
    ...
    <tr> 
      <td height="25"> <div align="center">时间从 
          ...
          <select name="show" id="show">
			...
			<option value="5"<?=$show==5?' selected':''?>>用户ID</option>
...
<form name="form2" method="post" action="ListDolog.php" onsubmit="return confirm('确认要删除?');">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
  <?=$ecms_hashur['form']?>
  <?php echo heformhash_get('DelDoLog_all'); ?>
    <tr class="header"> 
      <td width="8%"> 
  ...
  ?>
    <tr bgcolor="#DBEAF5" id=log<?=$r['logid']?>> 
      ...
      <td height="25"> 
        <div align="center">[<a href="ListDolog.php?enews=DelDoLog&logid=<?=$r['logid']?><?=$ecms_hashur['href'].$efh?>" onclick="return confirm('确认要删除此日志?');">删除</a> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td height="25" colspan="5"><table width="100%" border="0" cellspacing="1" cellpadding="3">
          <tr>
            ...
            <td width="10%">操作对像：</td>
            <td width="56%"><?=stripSlashes($r['doing'])?></td>
          </tr>
        </table></td>
    </tr>
    <?php
...
<form action="ListDolog.php" method="post" name="dellogform" id="dellogform" onsubmit="return confirm('确认要删除?');">
  ...
  <?=$ecms_hashur['form']?>
  <?php echo heformhash_get('DelDoLog_date'); ?>
    <tr> 
      <td><div align="center">
